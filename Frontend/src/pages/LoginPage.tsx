      ...
      <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-6xl overflow-hidden rounded-[2rem] bg-white shadow-2xl shadow-slate-900/10 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative hidden overflow-hidden bg-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative">
            ...
            <h1 className="max-w-lg text-5xl font-semibold leading-[1.05] tracking-tight">
              Grounded answers from the knowledge you already have.
            </h1>
          </div>
          <p className="relative max-w-sm text-sm leading-6 text-slate-400">
            Upload your documents, retrieve the most relevant context, and get reliable answers without losing the source behind them.
          </p>
        </section>
        ...
        <section className="flex items-center px-6 py-12 sm:px-12 lg:px-16">
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="mb-8">
              <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-cyan-700">Welcome back</p>
              <h2 className="text-3xl font-semibold tracking-tight text-slate-950">Continue exploring your knowledge base</h2>
              <p className="mt-3 text-sm leading-6 text-slate-500">Sign in to chat with your documents and find answers backed by relevant context.</p>
            </div>
            <LoginForm />
            <p className="mt-8 text-center text-sm text-slate-500">
              New to AI Document Assistant?{" "}
              <Link className="font-semibold text-cyan-700 hover:text-cyan-900" to="/signup">
                Create an account
              </Link>
            </p>
          </div>
